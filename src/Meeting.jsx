...
import cop_meet from './assest/cop_meet.jpg';
import Header from './Component/Header';
import outdoor_cop_meet from './assest/outdoor_cop_meet.jpg';
const Meeting = () =>{
 return (
    <div>
        ...
        <div className='inner-box1'>
         <div className='blured-box'>
          ...
          <section className='b-details'>
              ...
              <div className="b-img">
                  <img src={cop_meet} alt="meeting" />
              </div>
              <div className='birthday-cont'>
                  <p>Looking for a catering service that truly cares about your special day? 
                    Join forces with us to make your wedding celebration unforgettable! Our 
                    cooperative catering service offers a diverse range of mouth-watering 
                    veg and non-veg dishes, carefully prepared and delivered fresh to your venue. 
                    By working together, we'll ensure that every detail is tailored to your 
                    needs, making your wedding day a truly memorable and joyful experience 
              ...
              <div className='food-details'>
                  ...
                  <div className='food-img1-meet'>
                      <img src={outdoor_cop_meet} alt={outdoor_cop_meet} className='image-of-wed'/>
