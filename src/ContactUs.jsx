  ...
  return (
    <div>
        ...
        <div className="box2-side">
            ...
            <div className="cont-box2-details">
            <div className='cont-logo'>

                <div className="cont-bx2-detail-1">
    ...
    <path d="M18 20C18 21.1046 15.3137 22 12 22C8.68629 22 6 21.1046 6 20" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" />
                ...
                <div className="cont-bx2-detail-2">
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width={24} height={24} color={"#ffffff"} fill={"none"}>
    ...
    <path d="M8.58815 12.3773L9.45909 11.2956C9.82616 10.8397 10.2799 10.4153 10.3155 9.80826C10.3244 9.65494 10.2166 8.96657 10.0008 7.58986C9.91601 7.04881 9.41086 7 8.97332 7C8.40314 7 8.11805 7 7.83495 7.12931C7.47714 7.29275 7.10979 7.75231 7.02917 8.13733C6.96539 8.44196 7.01279 8.65187 7.10759 9.07169C7.51023 10.8548 8.45481 12.6158 9.91948 14.0805C11.3842 15.5452 13.1452 16.4898 14.9283 16.8924C15.3481 16.9872 15.558 17.0346 15.8627 16.9708C16.2477 16.8902 16.7072 16.5229 16.8707 16.165C17 15.8819 17 15.5969 17 15.0267C17 14.5891 16.9512 14.084 16.4101 13.9992C15.0334 13.7834 14.3451 13.6756 14.1917 13.6845C13.5847 13.7201 13.1603 14.1738 12.7044 14.5409L11.6227 15.4118" stroke="currentColor" strokeWidth="1.5" />
                ...
                <div className="cont-bx2-detail-3">
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width={24} height={24} color={"#ffffff"} fill={"none"}>
    ...
    <path d="M6.96014 3.69772C5.6417 4.07415 4.69384 4.54112 3.82645 5.10455C2.45318 5.9966 1.86443 7.60404 2.02607 9.15513C2.09439 9.81068 2.62064 10.1241 3.23089 9.95455C3.69451 9.82571 4.15888 9.7003 4.61961 9.56364C5.96706 9.16397 6.28399 8.67812 6.47124 7.29885L6.96014 3.69772ZM6.96014 3.69772C10.2186 2.76743 13.7814 2.76743 17.0399 3.69772M17.0399 3.69772C18.3583 4.07415 19.3062 4.54112 20.1735 5.10455C21.5468 5.9966 22.1356 7.60404 21.9739 9.15513C21.9056 9.81068 21.3794 10.1241 20.7691 9.95455C20.3055 9.82571 19.8411 9.7003 19.3804 9.56364C18.0329 9.16397 17.716 8.67812 17.5288 7.29885L17.0399 3.69772Z" stroke="currentColor" strokeWidth="1.5" strokeLinejoin="round" />
                ...
                <div className="cont-bx2-detail-4">
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width={24} height={24} color={"#ffffff"} fill={"none"}>
    ...
    <path d="M19 17C19 17.8284 18.3284 18.5 17.5 18.5C16.6716 18.5 16 17.8284 16 17C16 16.1716 16.6716 15.5 17.5 15.5C18.3284 15.5 19 16.1716 19 17ZM19 17V17.5C19 18.3284 19.6716 19 20.5 19C21.3284 19 22 18.3284 22 17.5V17C22 14.5147 19.9853 12.5 17.5 12.5C15.0147 12.5 13 14.5147 13 17C13 19.4853 15.0147 21.5 17.5 21.5" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
            ...
            <div className='cont-logo-detail'>
                {/* for box2 written text */}
                <div className="cont-bx2-details-1"> 
                    <h4>India</h4>
                </div>
                <div className="cont-bx2-details-2">
                    <h4>Chat on WhatsApp</h4>
                </div>
                <div className="cont-bx2-details-2">
                    <h4>+971 50 663 2853</h4>
                </div>
                <div className="cont-bx2-details-3">
                    <h4>hello@masalamingle.com</h4>
                </div>
                <div className="cont-bx2-details-4">
                </div>
            </div>
        ...
        <div className="box1-side">
            <div className="box1-side-form">
                <div className="cont-box1-heading">
                    <h1>Contact Us</h1>
                </div>
            <div className="cont-form">
                ...
                <form className='contactus'>
                    ...
                    <div className="cont-lbl3">
                    <label>Full Catering Service</label>
                    <input type="radio" id="radio" name="radio"></input>
                    <label>Delivered Service</label>
                    <input type="radio" id="radio" name="radio"></input>
                    </div> 

                    <div className="cont-lbl5">
                    <label >Event Location</label>
                    <input type="text" placeholder='Enter your Name' />
                    </div>
                    <div className="cont-lbl6">
                    <label>Number of Guest</label>
                    <input type="number" placeholder='no. of Guest' />
                    </div>

                    <div className="cont-lbl7">
                    <label>Customize your Event</label>
                    <input type="message" placeholder='You can customize your event by speifying the details that you wanted to add' />
                    </div>
